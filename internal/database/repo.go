...
type DatabaseRepo interface {
	...
	GetBookByIsbnForLibrary(isbn string, libraryId int) (*models.Book, *models.BookMetadata, error)
	GetBookByIsbn(ISBN string) (*models.Book, *models.BookMetadata, error)
